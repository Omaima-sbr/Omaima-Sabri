...
const CV_URL = "https://hsjtczjysyjaopvecvgy.supabase.co/storage/v1/object/public/cv/Omaima_Sabri_CV.pdf";
...
const Header = memo(() => (
  <div className="text-center lg:mb-8 mb-2 px-[5%]">
    ...
    >
      ...
      Building secure digital experiences through code and curiosity
      <Sparkles className="w-5 h-5 text-purple-400" />
    </p>
  </div>
));
...
const CVModal = memo(({ onClose }) => (
  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
    <div className="relative w-full max-w-4xl h-[90vh] bg-white rounded-xl overflow-hidden shadow-2xl">
      <div className="flex items-center justify-between px-4 py-2 bg-gray-900">
        <span className="text-white text-sm font-medium">CV — Omaima Sabri</span>
        <button
          onClick={onClose}
      ...
      {/* Mobile fallback: iframe doesn't work well on mobile */}
      <iframe
        src={CV_URL}
        className="w-full h-full hidden sm:block"
        title="CV Omaima Sabri"
      />
      {/* Mobile: open in new tab instead */}
      <div className="flex flex-col items-center justify-center h-full gap-4 sm:hidden p-8 text-center">
        <FileText className="w-12 h-12 text-gray-400" />
        <p className="text-gray-600 text-sm">L'aperçu PDF n'est pas disponible sur mobile.</p>
        <a
          href={CV_URL}
          target="_blank"
          rel="noopener noreferrer"
          className="px-6 py-2 rounded-lg bg-gradient-to-r from-[#6366f1] to-[#a855f7] text-white text-sm font-medium"
        >
          Ouvrir le CV
        </a>
      </div>
      ...
      <div className="w-full mx-auto pt-8 sm:pt-12 relative">
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            >
              A Computer Engineering student who fell in love with security, the kind that lives in code, not theories. I break things to build them better. specializing in Application Security & Cloud. bridging the gap between development and security through web audits and secure full-stack projects. Currently seeking a PFA internship in AppSec, technical auditing, or vulnerability analysis. </p>
